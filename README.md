...
fountain-screenplay = *empty-line *1cover-page script-content

cover-page = 1*cover-entry

cover-entry = cover-key *space ":" *space cover-value

cover-key = %i"TITLE" / "CREDIT" / "AUTHOR" / "SOURCE" / "DRAFT" 1*space "DATE" / "CONTACT"
...
indented-sub-value = 2*8space 1*non-newline newline
...
space = " "
      ...
      ; These are turned into one or more regular spaces; we're trying to imitate a typewriter.
...
newline = CR [LF]
        ...
        ; These are all converted into your OS's native newline
