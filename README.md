...
script-element =  *space (section / synopse / boneyard / note)
script-element =/ 1*empty-line *space (section / synopse / boneyard / note / transition / scene / scene-content)
...
section = 1*"#" 1*non-newline newline <lookahead: empty-line>
